            ...
            <div class="container mx-auto px-4 md:px-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <p
                            class="text-sm max-w-xs text-slate-400 leading-relaxed"
                        >
                            Building the future of web development with Nuxt 4
                            and Tailwind CSS v4. Fast, scalable, and beautiful.
                        </p>
                    </div>
                    <div>
