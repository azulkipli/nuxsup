    ...
    <div class="w-full max-w-md p-6 relative z-10">
      ...
      <div class="flex justify-center mb-8">
        <i18n-link to="/" class="flex items-center gap-2 group">
          <div
            class="bg-indigo-600 text-white w-10 h-10 rounded-xl flex items-center justify-center font-bold text-xl shadow-lg group-hover:scale-105 transition-transform duration-300"
          >
            N
          </div>
