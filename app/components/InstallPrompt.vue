<template>
  <div v-if="showInstallPrompt" class="fixed bottom-5 left-5 right-5 z-[9998] animate-slide-up sm:left-auto sm:right-5 sm:max-w-[380px]">
    <div class="bg-linear-to-br from-[#667eea] to-[#764ba2] text-white px-5 py-4 rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.3)] flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
